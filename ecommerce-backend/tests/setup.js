...
// AI provider — controller checks for presence at module load to gate features off.
// Tests mock the SDK itself, so any non-empty value here just keeps the gate open.
