...
export default function ForgotPassword() {
  ...
  return (
    <div className="flex w-full max-w-[1100px] min-h-[550px] bg-white border border-black/[0.08] rounded-xl mx-auto my-5 overflow-hidden shadow-card md:flex-col md:max-w-[500px] md:min-h-0 md:mx-4 sm:mx-2.5 sm:rounded-lg">
      {/* LEFT PANEL */}
      <div
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
            ...
            <div className="hidden md:block text-center mb-4">
              ...
              <p className="text-black/60">Enter your email to reset it</p>
            </div>
