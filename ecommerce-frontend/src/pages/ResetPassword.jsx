  ...
  return (
    <div className="w-full px-4 py-6 md:py-8">
      <div className="w-full max-w-[480px] mx-auto md:max-w-[1100px]">
        <div className="bg-white border border-black/[0.08] rounded-xl overflow-hidden shadow-card flex flex-col md:flex-row md:min-h-[520px]">
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
                <div className="text-center mb-2 md:hidden">
                  ...
                  <p className="text-black/60 text-sm">Choose a strong password</p>
                </div>
